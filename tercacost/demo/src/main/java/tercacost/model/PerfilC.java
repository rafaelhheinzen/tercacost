...
public class PerfilC extends PerfilEstrutural{
    private double mlManual = 0.0; // Momento crítico local manual (N.mm)
    private double mdistManual = 0.0; // Momento crítico distorcional manual (N.mm)
 ...
 public PerfilC(double alturaAlma, double larguraAba, double larguraEnrijecedor, double espessuraChapa, double tensaoEscoamentoAco, double tensaoRuptura, double moduloElasticidade, double moduloElasticidadeTransversal) {
        ...
        public PerfilC(double alturaAlma, double larguraAba, double larguraEnrijecedor, double espessuraChapa, double tensaoEscoamentoAco, double tensaoRuptura, double moduloElasticidade, double moduloElasticidadeTransversal, double mlManualKnm, double mdistManualKnm) {
    ...
    public double getMlManual() {
        return mlManual / 1.0e6; // Converte N.mm para kN.m
    }
    ...
    public double getMdistManual() {
        return mdistManual / 1.0e6; // Converte N.mm para kN.m
    }
    ...
    public double calcularMomentoCriticoLocal() {
        ...
        // Fator atualizado de 4.0 para 23.9 (flexão simples na alma - NBR 14762)
    ...
    public double calcularPesoPorMetro() {
        // Área em mm² convertida para m² (*) densidade do aço (7850 kg/m³) dividido por 1000 para ajustar a escala
        // Fórmula prática: Area(mm²) * 7.85 / 1e6 * 1000 -> Area * 0.00785
        return (calcularArea() / 1.0e6) * 7850.0;
    }
